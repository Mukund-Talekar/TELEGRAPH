...
async def home(client, message):
  buttons = [[
        InlineKeyboardButton('Lᴏᴠᴇʟʏ ɴᴇᴛᴡᴏʀᴋ 📶', url='https://t.me/LOVELY_NETWORK')
            ]]
...
Made With Love By @LOVELY_NETWORK</b>""",
...
async def help(client, message):
  buttons = [[
        InlineKeyboardButton('❦ ℓσvєℓy ทєτωσrк💝', url='https://t.me/LOVELY_NETWORK')
    ]]
  reply_markup = InlineKeyboardMarkup(buttons)
  await Tgraph.send_message(
        chat_id=message.chat.id,
